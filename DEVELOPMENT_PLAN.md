...
| 2026-08-21 | H1.7 K-1 II initial read-only gate | PASS | PC-P mode is hardware-confirmed as `25fb:0183`, Imaging/PTP, exact model; vendor flags `0x00000003`; one 568-byte condition snapshot parsed safely; no writes/focus/preview/capture/transfer/delete/reset; see H1.7 |
